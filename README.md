...
This is a simple, clean Instagram Profile Grid UI Clone built with HTML, CSS and vanilla JavaScript. The goal of this project is to turn a static design into accessible, modern code — and make it easy for anyone to customize or learn from. It’s mobile responsive and includes a CSS Grid layout.
...
-   [Live demo on Github Pages](https://angelajholden.github.io/ig-grid-profile/)
...
```bash
git clone git@github.com:angelajholden/ig-grid-profile.git
```
